...
const pt: PartialTranslation = {
  ...
  checker: {
    inputPlaceholder: "Introduza o nome ou o URL do casino (ex.: Lucky Coin Casino ou luckycoin.cash)",
    inputLabel: "Nome do casino, endereço do site ou número de licença",
    button: "Consultar",
    steps: [
      { n: "1", title: "Introduza o nome ou o URL do casino" },
      { n: "2", title: "Pesquisamos no nosso índice de auditorias" },
      { n: "3", title: "Leia o registo da licença e da análise" },
    ],
    footnote: "{count} casinos indexados. Indicamos o número de licença que o casino publica, se consta do registo do próprio regulador emissor e a data em que consultámos.",
    emptyInput: "Escreva primeiro o nome de um casino, um endereço de site ou um número de licença.",
    recordEyebrow: "Registo no índice",
    jurisdiction: "Jurisdição",
    operator: "Empresa licenciada",
    licence: "Número de licença",
    licenceNone: "Nenhum publicado",
    licenceExpiry: "Validade da licença",
    licenceExpired: "Esta data já passou. Peça ao casino uma licença atual.",
    licenceMatched: "Encontrado em «{registry}» na consulta de {date}",
    licenceSecondhand: "Obtido de fontes públicas. Ainda sem correspondência num registo.",
    scan: "Análise técnica",
    scanNone: "Ainda não efetuada",
    noteLabel: "O que observámos",
    viewRecord: "Abrir o registo completo",
    multipleTitle: "Mais do que um casino corresponde",
    multipleBody: "Escolha o que pretendia.",
    notFoundTitle: "Não consta do índice",
    notFoundBody: "Não temos qualquer registo com esse nome, endereço ou número de licença. Isto não é uma conclusão contra o casino — significa apenas que ainda não o indexámos.",
    notFoundBrowse: "Ver o índice",
    notFoundApply: "Peça-nos para o analisar",
  },
  verify: {
