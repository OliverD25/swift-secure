...
const tr: PartialTranslation = {
  ...
  checker: {
    inputPlaceholder: "Casino adını veya web sitesini girin (örn. Lucky Coin Casino veya luckycoin.cash)",
    inputLabel: "Casino adı, web sitesi adresi veya lisans numarası",
    button: "Sorgula",
    steps: [
      { n: "1", title: "Casino adını veya web sitesini girin" },
      { n: "2", title: "Denetim dizinimizde arıyoruz" },
      { n: "3", title: "Lisans ve tarama kaydını okuyun" },
    ],
    footnote: "{count} casino dizine eklendi. Bir casinonun yayımladığı lisans numarasını, bu numaranın lisansı veren düzenleyici kurumun kendi sicilinde yer alıp almadığını ve baktığımız tarihi bildiriyoruz.",
    emptyInput: "Önce bir casino adı, web sitesi adresi veya lisans numarası yazın.",
    recordEyebrow: "Dizin kaydı",
    jurisdiction: "Yargı bölgesi",
    operator: "Lisanslı şirket",
    licence: "Lisans numarası",
    licenceNone: "Yayımlanmamış",
    licenceExpiry: "Lisans bitiş tarihi",
    licenceExpired: "Bu tarih geçmiş. Güncel lisansı casinodan isteyin.",
    licenceMatched: "{date} tarihinde baktığımızda {registry} sicilinde bulundu",
    licenceSecondhand: "Herkese açık kaynaklardan alındı. Henüz bir sicilde eşleştirilmedi.",
    scan: "Teknik tarama",
    scanNone: "Henüz yapılmadı",
    noteLabel: "Fark ettiklerimiz",
    viewRecord: "Kaydın tamamını açın",
    multipleTitle: "Birden fazla casino eşleşiyor",
    multipleBody: "Aradığınızı seçin.",
    notFoundTitle: "Dizinde yok",
    notFoundBody: "Bu ad, adres veya lisans numarası altında bir kaydımız yok. Bu, casino aleyhine bir bulgu değildir — yalnızca onu henüz dizine eklemediğimiz anlamına gelir.",
    notFoundBrowse: "Dizine göz atın",
    notFoundApply: "Kontrol etmemizi isteyin",
  },
  verify: {
