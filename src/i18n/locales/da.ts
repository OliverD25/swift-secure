...
const da: PartialTranslation = {
  ...
  checker: {
    inputPlaceholder: "Indtast casinonavn eller URL (f.eks. Lucky Coin Casino eller luckycoin.cash)",
    inputLabel: "Casinonavn, webadresse eller licensnummer",
    button: "Tjek",
    steps: [
      { n: "1", title: "Indtast casinonavn eller URL" },
      { n: "2", title: "Vi søger i vores auditindeks" },
      { n: "3", title: "Læs licens- og scanningsoplysningerne" },
    ],
    footnote: "{count} casinoer indekseret. Vi oplyser det licensnummer, et casino offentliggør, om det fremgår af den udstedende myndigheds eget register, og datoen for vores opslag.",
    emptyInput: "Indtast først et casinonavn, en webadresse eller et licensnummer.",
    recordEyebrow: "Indekspost",
    jurisdiction: "Jurisdiktion",
    operator: "Licenseret selskab",
    licence: "Licensnummer",
    licenceNone: "Ikke offentliggjort",
    licenceExpiry: "Licensen udløber",
    licenceExpired: "Denne dato er passeret. Bed casinoet om en aktuel licens.",
    licenceMatched: "Fundet i {registry} ved vores opslag den {date}",
    licenceSecondhand: "Hentet fra offentlige kilder. Endnu ikke fundet i et register.",
    scan: "Teknisk scanning",
    scanNone: "Ikke udført endnu",
    noteLabel: "Hvad vi bemærkede",
    viewRecord: "Åbn hele indeksposten",
    multipleTitle: "Flere casinoer matcher",
    multipleBody: "Vælg det, du mente.",
    notFoundTitle: "Ikke i indekset",
    notFoundBody: "Vi har ingen registrering under det navn, den adresse eller det licensnummer. Det er ikke en anmærkning mod casinoet — det betyder kun, at vi endnu ikke har indekseret det.",
    notFoundBrowse: "Gennemse indekset",
    notFoundApply: "Bed os om at tjekke det",
  },
  verify: {
