...
const es: PartialTranslation = {
  ...
  stats: [
    ...
    },
    {
      ...
      label: "Licencias halladas en el registro",
    },
    {
      count: "badged",
  ...
  checker: {
    inputPlaceholder: "Escriba el nombre o la URL del casino (p. ej., Lucky Coin Casino o luckycoin.cash)",
    inputLabel: "Nombre del casino, dirección web o número de licencia",
    button: "Consultar",
    steps: [
      { n: "1", title: "Escriba el nombre o la URL del casino" },
      { n: "2", title: "Buscamos en nuestro índice de auditorías" },
      { n: "3", title: "Consulte la licencia y el análisis técnico" },
    ],
    footnote: "{count} casinos indexados. Indicamos el número de licencia que publica un casino, si figura o no en el registro del propio regulador emisor, y la fecha en que lo consultamos.",
    emptyInput: "Escriba primero el nombre de un casino, una dirección web o un número de licencia.",
    recordEyebrow: "Ficha del índice",
    jurisdiction: "Jurisdicción",
    operator: "Empresa con licencia",
    licence: "Número de licencia",
    licenceNone: "No publicado",
    licenceExpiry: "Caducidad de la licencia",
    licenceExpired: "Esta fecha ya ha pasado. Pida al casino una licencia vigente.",
    licenceMatched: "Figura en {registry}, según nuestra consulta del {date}",
    licenceSecondhand: "Obtenido de fuentes públicas. Aún sin cotejar en un registro.",
    scan: "Análisis técnico",
    scanNone: "Aún no realizado",
    noteLabel: "Lo que observamos",
    viewRecord: "Ver la ficha completa",
    multipleTitle: "Coincide más de un casino",
    multipleBody: "Elija el que buscaba.",
    notFoundTitle: "No está en el índice",
    notFoundBody: "No tenemos ninguna ficha con ese nombre, dirección o número de licencia. Esto no es un hallazgo en contra del casino: solo significa que aún no lo hemos indexado.",
    notFoundBrowse: "Explorar el índice",
    notFoundApply: "Pídanos que lo comprobemos",
  },
  verify: {
