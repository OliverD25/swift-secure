...
const nl: PartialTranslation = {
  ...
  checker: {
    inputPlaceholder: "Voer casinonaam of URL in (bijv. Lucky Coin Casino of luckycoin.cash)",
    inputLabel: "Casinonaam, websiteadres of licentienummer",
    button: "Controleren",
    steps: [
      { n: "1", title: "Voer de casinonaam of URL in" },
      { n: "2", title: "Wij doorzoeken onze auditindex" },
      { n: "3", title: "Lees de licentie- en scangegevens" },
    ],
    footnote: "{count} casino's geïndexeerd. We vermelden het licentienummer dat een casino publiceert, of dat nummer voorkomt in het register van de uitgevende toezichthouder, en de datum waarop we hebben gekeken.",
    emptyInput: "Typ eerst een casinonaam, websiteadres of licentienummer.",
    recordEyebrow: "Indexvermelding",
    jurisdiction: "Rechtsgebied",
    operator: "Licentiehouder",
    licence: "Licentienummer",
    licenceNone: "Niet gepubliceerd",
    licenceExpiry: "Licentie verloopt",
    licenceExpired: "Deze datum is verstreken. Vraag het casino om een actuele licentie.",
    licenceMatched: "Gevonden in het {registry} bij onze controle op {date}",
    licenceSecondhand: "Overgenomen uit openbare bronnen. Nog niet gevonden in een register.",
    scan: "Technische scan",
    scanNone: "Nog niet uitgevoerd",
    noteLabel: "Wat ons opviel",
    viewRecord: "Volledige vermelding openen",
    multipleTitle: "Meerdere casino's gevonden",
    multipleBody: "Kies het casino dat u bedoelde.",
    notFoundTitle: "Niet in de index",
    notFoundBody: "Wij hebben geen vermelding onder die naam, dat adres of dat licentienummer. Dat is geen oordeel over het casino — het betekent alleen dat we het nog niet hebben geïndexeerd.",
    notFoundBrowse: "Index bekijken",
    notFoundApply: "Vraag ons om het te controleren",
  },
  verify: {
