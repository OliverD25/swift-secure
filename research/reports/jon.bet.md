...
## 33 requests fail when your homepage loads — 15 distinct files

```
530  https://jonbet.com/api/users/self-limits/start-tracking-time
530  https://jonbet.com/api/chat_rooms
530  https://jonbet.com/api/feature-flag-group/users/has-access?name=SportsUsabilityTest1
```
...
```
curl -sI 'https://jonbet.com/api/users/self-limits/start-tracking-time'
```

## Checked, nothing wrong

144 requests on the homepage, below the market median of about 135, mobile viewport set correctly, no insecure content on a secure page.
