# riskiiit.com — free technical check
...
## A single 39.3 MB video or audio file loads on your homepage
...
There are more behind it: 5.8 MB, 2.7 MB, 2.4 MB.
...
```
curl -sI 'https://riskiiit.com/sounds/riskItForTheBiscuit.wav' | grep -i content-length
```

## Checked, nothing wrong

78 requests on the homepage, below the market median of about 135, HTTPS with HSTS enabled, mobile viewport set correctly, no insecure content on a secure page.
