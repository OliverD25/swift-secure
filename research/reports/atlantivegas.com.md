# atlantivegas.com — free technical check
...
## 17 requests fail when your homepage loads — 16 distinct files

```
404  https://agstatic.com/wlc/icons/category/topgames.svg
404  https://agstatic.com/paysystems/V2/svg/color/dark/macpay_pixpay.svg
404  https://agstatic.com/paysystems/V2/svg/color/dark/paycryptos_pusdt_v2.svg
```
...
```
curl -sI 'https://agstatic.com/wlc/icons/category/topgames.svg'
```
