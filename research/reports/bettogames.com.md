# bettogames.com — free technical check
...
## 32 requests fail when your homepage loads — 20 distinct files

```
404  https://agstatic.com/paysystems/V2/svg/black/vasu_vnd_momo.svg
404  https://agstatic.com/paysystems/V2/svg/black/vasu_vnd_viettel.svg
404  https://agstatic.com/paysystems/V2/svg/black/vasu_vnd_banktransfer.svg
```
...
```
curl -sI 'https://agstatic.com/paysystems/V2/svg/black/vasu_vnd_momo.svg'
```
