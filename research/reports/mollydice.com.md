# mollydice.com — free technical check
...
## 13 requests fail when your homepage loads

```
404  https://d1bvoel1nv172p.cloudfront.net/competitors/images/normal/medium/2499626385199476766.png
404  https://d1bvoel1nv172p.cloudfront.net/competitors/images/normal/medium/1093393.png
404  https://d1bvoel1nv172p.cloudfront.net/competitors/images/normal/medium/396548.png
```

All of them are served from `d1bvoel1nv172p.cloudfront.net`, not from your own servers. That usually means the fix belongs to your platform provider rather than to your team — worth forwarding to them with this list.
...
```
curl -sI 'https://d1bvoel1nv172p.cloudfront.net/competitors/images/normal/medium/2499626385199476766.png'
```
