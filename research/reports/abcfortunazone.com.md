# abcfortunazone.com — free technical check
...
## 60 requests fail when your homepage loads — 18 distinct files

```
404  https://agstatic.com/wlc/icons/theme-wolf/categories/gameshows.svg
404  https://agstatic.com/wlc/icons/theme-wolf/categories/native.svg
404  https://agstatic.com/merchants/svg/black/adlunam.svg
```
...
```
curl -sI 'https://agstatic.com/wlc/icons/theme-wolf/categories/gameshows.svg'
```
